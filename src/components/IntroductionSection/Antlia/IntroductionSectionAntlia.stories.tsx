...
const meta: Meta<any> = {
  ...
  argTypes: {
    ...
    '--font-size-welcome-message': { control: 'text', name: '--font-size-welcome-message' },
    '--color-accent': { control: 'text', name: '--color-accent' },
    '--spacing-small': { control: 'text', name: '--spacing-small' },
    '--font-size-specialist-name': { control: 'text', name: '--font-size-specialist-name' },
    '--font-weight-bold': { control: 'text', name: '--font-weight-bold' },
    '--font-size-specialist-description': { control: 'text', name: '--font-size-specialist-description' },
    '--color-specialist-text': { control: 'text', name: '--color-specialist-text' },
    '--border-radius-medium': { control: 'text', name: '--border-radius-medium' },
    ...
    '--font-size-cta-button': { control: 'text', name: '--font-size-cta-button' },
